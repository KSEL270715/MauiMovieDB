...
namespace MauiMovieDB.ViewModels
{
    public class PopularMoviesViewModel : BaseViewModel
    {
        ...
        public PopularMoviesViewModel(IAPIService apiService, INavigationService navigationService, ISecurityService securityService)
        {
        ...
        public async override Task LoadDetails(object param = null)
        {
            try
            {
                MovieResults movieResults = await _apiService.GetRequestAsync<MovieResults>(AppConstants.GetPopularMovie);
